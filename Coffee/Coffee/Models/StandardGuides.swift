...
class StandardGuides {
    ...
    let frenchPress = Guide(userGuide: false, title: BrewKeys.frenchPressKey, method: BrewKeys.frenchPressKey, methodInfo: "A classic brewing method that is consistent and yields a enough coffee for guests.  Although filtering the grounds to the bottom, the French Press keeps the oils and grounds in the coffee producing full-bodied and gritty cup of coffee", coffee: 56.0, grind: GrindKeys.coarseKey, prep:
    """
    Things you'll need:
