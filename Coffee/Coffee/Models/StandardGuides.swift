...
class StandardGuides {
    ...
    let chemex = Guide(userGuide: false, title: "CHEMEX", method: "CHEMEX", methodInfo: "The CHEMEX was invented by a chemist in 1941.  The design was inspired by his lab equipment, is displayed at museums throughtout the world.  It produces a clean, crisp, yet balanced cup of coffee ", coffee: 42.0, grind: "Medium-Coarse", prep:
        """
        Things you'll need:
        8-cup CHEMEX brewer
        CHEMEX filter
    ...
    let aeroPress = Guide(userGuide: false, title: "AeroPress", method: "AeroPress", methodInfo: "The AeroPress was invented by Alan Adler, the same engineer of the Aerobie Frisbee, and allows for creative and various brewing methods.  Still, it provides a delicious, full-bodied cup in half the time.", coffee: 17.0, grind: "Medium-Fine", prep:
        """
        Things you'll need:
        AeroPress brewer
        AeroPress filter
    ...
    let v60 = Guide(userGuide: false, title: "Hario V60", method: "Hario V60", methodInfo: "Despite originating in the 1980's, HARIO's floating filter design didn't become a favorite among baristas until 2004, when they introduced their signature sprial ribbed V60.  This allows the user to control the brewing extration based on their pour.  A staple in craft coffee shops everywhere, this brewer is versatile and produces a great cup of coffee.", coffee: 21.0, grind: "Medium-Fine", prep:
        """
        Things you'll need:
        Hario V60 brewer
        Hario V60 filter
    ...
    let kalita = Guide(userGuide: false, title: "Kalita Wave", method: "Kalita Wave", methodInfo: "Similar to other pour overs, the Kalita Wave is all about mastering the slow, spiral pour.  However, unlike the HARIO V60, the Kalita Wave's flat bottom allows this brewing method to have a more even, consistent (thus more forgiving) extraction process.  The Kalita Wave produces a clean, balanced-bodied cup of coffee", coffee: 21.0, grind: "Medium-Fine", prep:
    """
    Things you'll need:
    Kalita Wave brewer
    Kalita Wave filter
    ...
    let frenchPress = Guide(userGuide: false, title: "French Press", method: "French Press", methodInfo: "A classic brewing method that is consistent and yields a enough coffee for guests.  Although filtering the grounds to the bottom, the French Press keeps the oils and grounds in the coffee producing full-bodied and gritty cup of coffee", coffee: 56.0, grind: "Coarse", prep:
    """
    Things you'll need:
