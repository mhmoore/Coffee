...
class UserNote {
    ...
    init(roaster: String, coffeeName: String, origin: String, grind: String, ratio: String, method: String, tastingNotes: String, timestamp: Date = Date()) { //, ckRecordID: CKRecord.ID?
